...
{"_id":{"$oid":"5ae62a37de17f189c24d57ba"},"authors":"Spann, P., R. Warner, R. Talbert, T. Elliott, S. Gillies","bbox":"-1.313677, 37.599034, -1.313677, 37.599034","connectsWith":"","created":"2010-09-24T19:02:51Z","creators":"P.O. Spann","currentVersion":3,"description":"An ancient place, cited: BAtlas 27 D4 Ficariensis Locus?","extent":"{'type': 'Point', 'coordinates': [-1.313677, 37.599034]}","featureTypes":"settlement","geoContext":"Mazarrón","hasConnectionsWith":"","id":265898,"locationPrecision":"precise","maxDate":300,"minDate":-30,"modified":"2012-10-20T19:11:22Z","path":"/places/265898","reprLat":37.599034,"reprLatLong":"37.599034,-1.313677","reprLong":-1.313677,"tags":"dare:ancient=1, dare:feature=settlement, dare:major=0","timePeriods":"R","timePeriodsKeys":"roman","timePeriodsRange":"-30.0,300.0","title":"Ficariensis Locus?","uid":"ea10d7d1df511e782e5bfed1a0989c5b"}


gawk < damrcs.json '{gsub("bbox":[,"bbox":");print}' > damrcs2.json

ndjson-map < damrcs.json '{"type": "Feature", "properties": {"OID": d.properties.ID, "MUT": d.properties.MUT,"geometry": {"type": "Point", "coordinates": d.geometry.coordinates}}{' > signDataQ.ndjson

mongoimport -h ds259079.mlab.com:59079 -d heroku_7rt6qd22 -c damform -u steve -p modernWater360 --file damrcs.json
